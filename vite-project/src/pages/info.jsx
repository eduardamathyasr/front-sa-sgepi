                ...
                <div key={epi.id} className="epi-item" data-id={epi.id}>
                  <div className="item">
                    ...
                    <div className="epi-actions">
                      <button id='RegistrarRetOuDev' className="retirar" onClick={() => redirecionarParaRetirarEpi(epi.id)}>Registrar</button>
                      <button id='EditarEpi' className="editar" onClick={() => redirecionarParaEditarEpi(epi.id)}>Editar</button>
                      <button id='RemoverEPI' className="remover" onClick={() => removerEpi(epi.id)}>Remover</button>
                    </div>
                  </div>
                </div>
              ))
              ...
              funcionarios.map((funcionario) => (
                <div key={funcionario.id} className="item" data-id={funcionario.id}>
                  ...
                  <div className="funcionario-actions">
                    <button id='editFunnn' className="editar" onClick={() => redirecionarParaEditarFuncionario(funcionario.id)}>Editar</button>
                    <button id='RemoverFun' className="remover" onClick={() => removerFuncionario(funcionario.id)}>Remover</button>
                  </div>
                </div>
              ))
            )}
